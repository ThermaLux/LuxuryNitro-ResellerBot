...
async def latest_version_check():
    try:
        async with httpx.AsyncClient() as client:
            github_data = await client.get("https://api.github.com/repos/ThermaLux/LuxuryNitro-ResellerBot/releases/latest")
...
async def startup():
    ...
    print("Coded with <3 | https://github.com/ThermaLux/LuxuryNitro-Reseller-Bot")
